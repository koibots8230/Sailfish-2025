...
public class IntakePivot extends SubsystemBase {
    ...
    public IntakePivot() {
        ...
        config.absoluteEncoder.positionConversionFactor(IntakePivotConstants.POSITION_CONVERSION_FACTOR);
        config.absoluteEncoder.velocityConversionFactor(IntakePivotConstants.VELCOITY_CONVERSION_FACTOR);
    ...
    motorSetpoint = 
        profile.calculate(RobotConstants.ROBOT_CLOCK_SPEED.in(Seconds), 
        motorSetpoint, 
        goal);

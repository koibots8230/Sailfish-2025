...
public class TestCommands {
  public static Command testSequence(
      Swerve swerve,
      Intake intake,
        ...
        Commands.sequence(
            ...
            Commands.either(
                Commands.sequence(
                    ...
                    Commands.waitUntil(
                        () -> intakePivot.atSetpoint(IntakePivotConstants.OUT_POSITION)),
                    intakePivot.setPositionCommand(IntakePivotConstants.IN_POSITION),
                    Commands.waitUntil(
                        () -> intakePivot.atSetpoint(IntakePivotConstants.IN_POSITION))),
                Commands.none(),
            ...
            Commands.either(
                Commands.sequence(
                    ...
                    Commands.waitUntil(
                        () -> elevator.atPosition(ElevatorConstants.INTAKE_POSITION))),
                Commands.none(),
